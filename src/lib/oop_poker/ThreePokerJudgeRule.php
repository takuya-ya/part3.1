...
class ThreePokerJudgeRule implements PokerJudgeRule
{
...
// $rule->getWinner([['name' => 'pair', 'hand rank' => 1, 'primary' => 9, 'secondly' => 9],
// ['name' => 'pair', 'hand rank' => 2, 'primary' => 8, 'secondly' => 7]]);
